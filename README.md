...
### Building
1. Build the CMake project using your preferred IDE or build system.
...
> - Red spheres = colliding objects
> - "GJK Collision mode" checkbox to toggle using GJK/EPA collision detection instead of basic shape methods
